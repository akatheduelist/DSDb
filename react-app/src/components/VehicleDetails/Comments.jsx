  ...
  return (
    <div className="p-6">
      <div className="px-4 sm:px-0">
        ...
        What DSDb users are saying about the {vehicle?.year} {vehicle?.make}{" "}
        {vehicle?.model}
        </p>
      </div>
          ...
          .map(({ id, rating, review, user_id, user }) => (
            <div key={id} className="p-4 antialiased flex max-w-xl">
              ...
              <div>
                ...
                <div className="bg-gray-300 border border-gray-100 rounded-full float-right -mt-8 mr-0.5 flex shadow items-center ">
                  <svg
                    className="p-0.5 h-5 w-5 rounded-full z-20"
                  ...
                  <svg
                    className="p-0.5 h-5 w-5 rounded-full -ml-1.5"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 16 16"
                  >
